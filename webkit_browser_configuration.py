...
c.aliases = {
    ...
    'wq': 'quit --save',
    'wqa': 'quit --save',
    'zap-colors': """jseval (function zap_colors() {console.log(\'turning off dark mode\');  var newSS;  var styles=\'* { background: white ! important; color: black !important } :link, :link * { color: #0000EE !important } :visited, :visited * { color: #551A8B !important }\';  if(document.createStyleSheet) {    document.createStyleSheet(\"javascript:\'\"+styles+\"\'\");  } else {    newSS=document.createElement(\'link\');    newSS.rel=\'stylesheet\';    newSS.href=\'data:text/css,\'+escape(styles);    document.getElementsByTagName(\"head\")[0].appendChild(newSS);  }})();""",
    'light-color-theme': """jseval (function zap_colors() {console.log(\'turning off dark mode\');  var newSS;  var styles=\'* { background: white ! important; color: black !important } :link, :link * { color: #0000EE !important } :visited, :visited * { color: #551A8B !important }\';  if(document.createStyleSheet) {    document.createStyleSheet(\"javascript:\'\"+styles+\"\'\");  } else {    newSS=document.createElement(\'link\');    newSS.rel=\'stylesheet\';    newSS.href=\'data:text/css,\'+escape(styles);    document.getElementsByTagName(\"head\")[0].appendChild(newSS);  }})();""",
...
'<Ctrl-Shift-F2>': 'scroll-to-perc',
    ...
    '<alt-w>': 'spawn --userscript copy-selection-to-kill-ring.sh',
    
    #'<ctrl-y>': 'insert-text {primary}',
    '<ctrl-alt-w>': 'spawn --userscript copy-selection-as-orgmode-quote.sh',
...
config.bind('<ctrl-y>', 'insert-text {primary};; spawn emacsclient --eval \'(kill-new \"{primary}\")\'')
